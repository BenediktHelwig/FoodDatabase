---
name: orchestrator
description: Coordinates the FoodDatabase multi-agent workflow — defines use-cases, assigns work to test-agent/dev-agent/doc-agent, tracks the 3-loop review process, and prepares merge requests. Use when starting a new use-case or coordinating a multi-phase feature across the other four agents.
